    ...
    return (
        ...
        <Grid centered stackable container columns={3}>
          ...
          <Grid.Column textAlign="centered">
            ...
            <Header inverted as="h3">This address book enables any number of users to register and save their business contacts. You can only see the contacts you have created.</Header>
          </Grid.Column>
          ...
          <Grid.Column textAlign="centered">
            <Icon inverted size="huge" name="checked calander"/>
